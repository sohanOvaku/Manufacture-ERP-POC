...
export class AuthorService {
  private _url:string = environment.API_BASE_URL+"/authors";
  ...
  addNomineeByAuthorPhoneNo(id:number,data:any):Observable<ApiResponse<any>>{
    return this.http.post<ApiResponse<any>>(this._url+'/'+id+'/nominees',data);
  }
